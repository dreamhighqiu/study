...
try:
    from douyin.handle_mongo import save_task,save_data,get_task
except:
    from handle_mongo import save_task,save_data,get_task
...
def handle_decode(input_data,share_web_url,task):
    ...
    if 'douyin_id' in task:
        douyin_info['douyin_id'] = task['share_id']
    else:
...
if __name__ == '__main__':
    # res = {'share_id': '88445518961', 'task_type': 'share_id'}
    # handle_douyin_web_share(res)
